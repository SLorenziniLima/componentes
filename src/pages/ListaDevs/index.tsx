...
const [dev, setDevs] = useState<any[]>([
...
const [listaDevsFiltrados, setListaDevsFIltrados] = useState<any[]>(dev);

function buscarPorSkill(event: any){

    event.preventDefault();

    const devsFiltrados = dev.filter((dev: any) => dev.skills.includes(skillDigitada.toLocaleUpperCase()) );
